    ...
    std::shared_ptr<AiryEngine::ResourceManager> resource_manager)
{
    ...
    this->model_start_offset = glm::vec3(0, -0.302f, 0);
    ...
    this->model_start_scale = glm::vec3(0.708f, 0.708f, 0.708f);
    ...
    this->colliding_cube_start_offset = glm::vec3(0, -0.620f, -0.753f);
    ...
    this->colliding_cube_start_scale = glm::vec3(3.569f, 0.395f, 4.317f);
...
void Road::set_visible(bool visible)
{
    this->visible = visible;
}


void Road::set_position(glm::vec3 position)
{
...
void Road::set_position(float position_x, float position_y, float position_z)
{
...
void Road::set_scale(glm::vec3 scale)
{
    this->scale = scale;
...
void Road::set_scale(float scale_x, float scale_y, float scale_z)
{
...
void Road::set_rotate(glm::vec3 rotate)
{
    this->rotate = rotate;
...
void Road::set_rotate(float rotate_x, float rotate_y, float rotate_z)
{
