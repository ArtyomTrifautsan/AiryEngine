    ...
    std::shared_ptr<AiryEngine::ResourceManager> resource_manager)
{
    ...
    // this->model_start_offset = glm::vec3(-2.821f, 0.302f, 0);
    this->model_start_offset = glm::vec3(0, 0.305f, 0);
    ...
    this->model_start_scale = glm::vec3(0.300f, 0.300f, 0.300f);
    ...
    // this->colliding_cube_start_offset = glm::vec3(-0.025f, 0.400f, 0);
    this->colliding_cube_start_offset = glm::vec3(0, 0.410f, 0);
    ...
    this->colliding_cube_start_scale = glm::vec3(0.360f, 0.360f, 0.360f);
...
void Coin::set_visible(bool visible)
{
    this->visible = visible;
}


void Coin::set_position(glm::vec3 position)
{
...
void Coin::set_position(float position_x, float position_y, float position_z)
{
...
void Coin::set_scale(glm::vec3 scale)
{
    this->scale = scale;
...
void Coin::set_scale(float scale_x, float scale_y, float scale_z)
{
...
void Coin::set_rotate(glm::vec3 rotate)
{
    this->rotate = rotate;
...
void Coin::set_rotate(float rotate_x, float rotate_y, float rotate_z)
{
